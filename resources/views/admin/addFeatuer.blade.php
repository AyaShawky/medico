...
<section id="main-content">
    <section class="wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-files-o"></i> feature</h3>
          <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
          <section class="panel">
            ...
            <div class="panel-body">
              <div class="form">
                <form class="form-validate form-horizontal" id="feedback_form" method="post" action="/feature" enctype="multipart/form-data">
                    @csrf
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="description" type="text"rows="5" name="description" required />
                    </div>
                  </div>
