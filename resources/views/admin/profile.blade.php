          ...
          <div class="profile-widget profile-widget-info">
            <div class="panel-body">
              ...
              <div class="col-lg-4 col-sm-4 follow-info">
                <p>Hello I’m admin Smith, a leading expert in interactive and creative design.</p>
                <p>@jenifersmith</p>
                <p><i class="fa fa-twitter">admin</i></p>
                <h6>
                ...
                <div id="profile" class="tab-pane">
                  <section class="panel">
                    <div class="bio-graph-heading">
                      Hello I’m admin, a leading expert in interactive and creative design specializing in the mobile medium. My graduation from Massey University with a Bachelor of Design majoring in visual communication.
                    </div>
                    <div class="panel-body bio-graph-info">
                      <h1>Bio Graph</h1>
                      <div class="row">
                        <div class="bio-row">
                          <p><span>First Name </span>: admin </p>
                        </div>
                        <div class="bio-row">
                          <p><span>Last Name </span>: Smith</p>
                        </div>
                        <div class="bio-row">
                          <p><span>Birthday</span>: 27 August 2021</p>
                        </div>
                        <div class="bio-row">
                        ...
                        <div class="bio-row">
                          <p><span>Email </span>:admin@mailname.com</p>
                        </div>
                        <div class="bio-row">
